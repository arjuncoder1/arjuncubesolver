...
public class OpenCvRaspberryPiCamera implements CubeColorInspector{
    ...
    public char[][] inspectBackFace(char center) {
        ...
        return new char[][]{//returns a 2 dimensional array of the colors of the back face
                {
                        findColor( 750,  540,  90,  85),
                        findColor(1030,  390,  240,  90),
                        findColor(1320,  200, 290, 90)
                },
                {   // middle row
                        findColor( 680,  880,  140,  250),
                        center,
                        findColor(1310,  470, 280, 215)
                },
                {   // bottom row
                        findColor( 610, 1210, 155, 250),
                        findColor( 860, 1120, 220, 250),
                        findColor(1180,  930, 390, 290)
                }
        };
    }
    ...
    public char[][] inspectLeftFace(char center) {
        ...
        return new char[][]{
                {
                        findColor(1915,60,225,100),
                        findColor(1905,485,200,125),
                        findColor(1890,1030,90,50),
                },
                {
                        findColor(2280,435,300,215),
                        center,
                        findColor(2395,1305,125,275)
                },
                {
                        findColor(2595,625,375,315),
                        findColor(2695,1045,200,275),
                        findColor(2775,1490,150,300)
                },
        };
    }
    ...
    public char[][] inspectDownFace(char center) {
        ...
        return new char[][]{
                {
                        findColor(2470,1960,375,95),
                        findColor(2150,1790,300,65),
                        findColor(1580,1550,80,40),
                },
                {
                        findColor(2010,2020,375,125),
                        center,
                        findColor(1215,1730,150,90)
                },
                {
                        findColor(1855,2095,500,180),
                        findColor(1385,2000,250,190),
                        findColor(795,1865,280,75)
                },
        };
    }
    ...
    public static char classifyColor(Mat square) {
        ...
        for (int row = 0;labSquare.rows() > row;row++) {//TODO use the for loop to go through every row
            for (int col = 0; labSquare.cols() > col;col++) {//TODO use a for loop to go through every column
